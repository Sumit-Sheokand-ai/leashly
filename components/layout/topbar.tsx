  ...
  return (
    <header className="h-14 bg-[#080808] border-b border-[#141414] flex items-center justify-between px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-2 text-sm">
        <span className="text-[#333333] font-mono text-xs">Leashly</span>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-[#1a1a1a]">
          {/* Avatar */}
          <div className="w-7 h-7 rounded-full bg-[#00ff88]/15 border border-[#00ff88]/20 flex items-center justify-center">
