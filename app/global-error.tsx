...
// app/error.tsx cannot. This must render its own <html>/<body>.
export default function GlobalError({
  ...
  useEffect(() => {
    console.error("[Leashly GlobalError]", error);
  }, [error]);
      ...
      <body className="bg-[#0a0a0a] text-[#f0f0f0] min-h-screen flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-[#666666] text-sm mb-2">
            The app hit an unexpected error and couldn&apos;t load. It has been logged.
          </p>
          {error.digest && (
