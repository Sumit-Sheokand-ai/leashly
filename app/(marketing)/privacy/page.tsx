  ...
  return (
    <div className="min-h-screen bg-[var(--surface-0)] text-[var(--text-bright)]">
      <div className="max-w-3xl mx-auto px-6 py-24">
        <div className="mb-12">
          <Link href="/" className="text-sm text-[var(--text-ghost)] hover:text-[var(--green)] transition-colors font-mono mb-8 block">← leashly.dev</Link>
        ...
        <div className="prose-leashly space-y-10">
          <section>
            ...
            <p className="text-[var(--text-dim)] leading-relaxed text-sm">
              ...
              We are reachable at <a href="mailto:support@leashly.dev" className="text-[var(--green)] hover:underline">support@leashly.dev</a>.
            </p>
          </section>
          <section>
            ...
            <div className="space-y-3 text-sm text-[var(--text-dim)] leading-relaxed">
              ...
              <p><span className="text-white font-medium">Usage data:</span> Analytics about how you use the dashboard via Google Analytics.</p>
              <p><span className="text-white font-medium">Cookies:</span> Session cookies for authentication and analytics cookies. See Section 6.</p>
            </div>
          </section>
          <section>
            ...
            <ul className="space-y-2 text-sm text-[var(--text-dim)] leading-relaxed list-none">
              {["Provide and operate the Leashly proxy service","Show you usage analytics and cost breakdowns","Send email alerts when you configure spend or rate limit notifications","Process payments via Stripe","Improve the service and fix bugs","Respond to support requests"].map(item => (
                <li key={item} className="flex items-start gap-2"><span className="text-[var(--green)] shrink-0 mt-0.5">✓</span>{item}</li>
              ))}
            </ul>
          </section>
          <section>
            <h2 className="font-mono text-lg font-bold text-white mb-3">4. Data sharing</h2>
            <p className="text-sm text-[var(--text-dim)] leading-relaxed mb-3">We do not sell your data. We share data only with:</p>
            <ul className="space-y-2 text-sm text-[var(--text-dim)] leading-relaxed list-none">
              {["Supabase — database hosting (US servers)","Stripe — payment processing","Resend — transactional email delivery","Vercel — hosting and deployment","Google Analytics — anonymous usage analytics"].map(item => (
                <li key={item} className="flex items-start gap-2"><span className="text-[var(--text-ghost)] shrink-0">·</span>{item}</li>
              ))}
            </ul>
          </section>
          <section>
            ...
            <div className="space-y-2 text-sm text-[var(--text-dim)] leading-relaxed">
              ...
              <p>Delete your account at any time from Dashboard → Settings → Danger Zone.</p>
            </div>
          </section>
          <section>
            ...
            <div className="space-y-3 text-sm text-[var(--text-dim)] leading-relaxed">
              ...
              <p><span className="text-white font-medium">Analytics cookies:</span> Google Analytics. You can opt out via our cookie banner or browser settings.</p>
          ...
          <section>
            ...
            <ul className="space-y-2 text-sm text-[var(--text-dim)] list-none mb-3">
              {["Access the personal data we hold about you","Request correction of inaccurate data","Request deletion of your data","Export your data in a portable format","Opt out of analytics tracking"].map(item => (
                <li key={item} className="flex items-start gap-2"><span className="text-[var(--green)] shrink-0 mt-0.5">✓</span>{item}</li>
              ))}
            </ul>
            <p className="text-sm text-[var(--text-dim)] leading-relaxed">
              To exercise any of these rights, email <a href="mailto:support@leashly.dev" className="text-[var(--green)] hover:underline">support@leashly.dev</a>.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-sm text-[var(--text-dim)] leading-relaxed">
              Questions? Email <a href="mailto:support@leashly.dev" className="text-[var(--green)] hover:underline">support@leashly.dev</a>.
            </p>
          </section>
        </div>
      </div>
