  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-[#111111] border border-[#1f1f1f] rounded-xl p-8">
        ...
        <p className="text-[#555555] text-sm mb-6">Start protecting your AI spend in minutes</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-[#cccccc] mb-1.5">Confirm password</label>
